"use strict";
const display = document.getElementById("display"), starter = document.getElementById("start"), stopper = document.getElementById("stop"), resetter = document.getElementById("reset");
let timer, startTime = 0, elapsed = 0, isRunning = false;
